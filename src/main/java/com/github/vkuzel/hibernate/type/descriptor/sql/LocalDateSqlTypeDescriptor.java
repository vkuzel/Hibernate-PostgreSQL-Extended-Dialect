...
public class LocalDateSqlTypeDescriptor implements SqlTypeDescriptor {

    public static final LocalDateSqlTypeDescriptor INSTANCE = new LocalDateSqlTypeDescriptor();
